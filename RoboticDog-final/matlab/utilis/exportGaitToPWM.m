...
%   filename - string, output CSV file name
    ...
    LF_deg(:,2)=LF_deg(:,2)-offsets(2);
    LF_deg(:,3)=LF_deg(:,3)-offsets(3);
    % 
    RF_deg(:,1)=offsets(4)-RF_deg(:,1);
    RF_deg(:,2)=RF_deg(:,2)-offsets(5);
    RF_deg(:,3)=RF_deg(:,3)-offsets(6);
    % 
    LH_deg(:,1)=LH_deg(:,1)-offsets(7);
    LH_deg(:,2)=LH_deg(:,2)-offsets(8);
    LH_deg(:,3)=LH_deg(:,3)-offsets(9);
    %
    RH_deg(:,1)=offsets(10)-RH_deg(:,1);
    RH_deg(:,2)=RH_deg(:,2)-offsets(11);
    RH_deg(:,3)=RH_deg(:,3)-offsets(12);
