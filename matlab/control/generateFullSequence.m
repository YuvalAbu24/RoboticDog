...
gait_walk1 = walkFixedDistance(robot, 'trot', stride, step_height, 2000, 40);
...
gait_walk2 = walkFixedDistance(robot, 'trot', stride, step_height, 2000, 40);
...
% === Export CSV ===
exportGaitToPWM(gait_total, 'full_mission_sequence.csv');
