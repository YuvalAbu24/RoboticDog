function [branch1,branch2,branch3,branch4]=InverseKinematic_HR(px,py,pz)

disp('')
disp('backward right foot :')
disp('')
...
A1_0_hr=[c1 0 -s1 100*c1;s1 0 c1 100*s1;0 -1 0 0;0 0 0 1];
A2_1_hr=[c2 0 s2 0;s2 0 -c2 0;0 1 0 -134.3;0 0 0 1];
A3_2_hr=[c3 -s3 0 125*c3;s3 c3 0 125*s3;0 0 1 42;0 0 0 1];
A4_3_hr=[c4 -s4 0 125*c4;s4 c4 0 125*s4;0 0 1 0;0 0 0 1];
A_hr=simplify(A1_0_hr*A2_1_hr*A3_2_hr*A4_3_hr);


% %regular Model with fixed theta1= -pi/2
A=subs(A_hr,s1,sin(-pi/2));
...
disp('always take the first branch')
